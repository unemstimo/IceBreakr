...
const MyPlaylists = () => {
  ...
  return (
    <div>
      <Link href={"/profile"} className="md:hidden flex">
        <Button className="bg-transparent w-12 h-12 flex items-center align-middle hover:bg-neutral-700">
          <PlaylistPlayRoundedIcon sx={{fontSize: 32}} />
        </Button>
      </Link>
