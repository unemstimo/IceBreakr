...
import rollespillImage from "./Rollespill.jpg";
import dansImage from "./Dans.jpg";
...
const categoryImages = {
    ...
    brettspill : brettspillImage,
    hagelek : hagelekImage,
    gjettelek : gjettelekImage,
    navnelek : navnelekImage,
