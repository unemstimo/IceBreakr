...
export default function Dashboard() {
  return (
    <div>
      ...
      <main className="flex font-darker min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white">
        <SignedOut>
          <SignInButton />
          <p>
        ...
        <SignedIn>
            ...
            <div className='flex w-full max-w-screen-xl h-screen bg-violet-500 rounded-3xl'>
                <section className='rounded-2xl flex-col w-1/4 bg-lime-500 flex align-middle justify-center p-0 m-2'>
                    <div className='rounded-2xl w-full h-full max-h-40 bg-slate-500 flex flex-col align-middle justify-center p-2 mb-2'>
                        <button className='w-full h-full hover:bg-lime-500'>User</button>
                        <button className='w-full h-full hover:bg-rose-500'>Home</button>
                    </div>
                    <div className='rounded-2xl w-full h-full bg-teal-500 flex align-middle justify-center p-2' >
                        PLAYLIST
                    </div>
                </section>
